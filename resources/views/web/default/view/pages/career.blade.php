        ...
        <div class="row h-100 align-items-center py-5">
            <div class="col-lg-12">
                ...
                <p class=" text-muted mb-0 leading-loose">
                    TutoringSchool is a community of millions of learners.Want to be part of a team that believes in creative expression, true work-life balance, and making
                    an impact? Explore what’s possible at TutoringSchool.
                </p>
            </div>
        </div>
    </div>
        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-6 d-none d-lg-block">
                ...
                <ul style="line-height: 30px;">
                    ...
                    <li><i class="fas fa-check mr-2"></i> Monthly coffee/tea reimbursement of up to $25</li>
