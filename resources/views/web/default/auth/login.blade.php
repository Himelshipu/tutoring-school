            ...
            <div class="formBox level-login" dir="ltr">
                ...
                <div class="box loginBox">
                    ...
                    <form class="form" action="/login" method="post" id="loginForm"
                        ...
                        <input class="input-rem" type="checkbox" name="remember" value="1"
                               style="display:block;position: relative;top: 16px;width: auto;height: auto"><label
                            style="margin-left: 15px;">{{ trans('main.remember') }}</label>
                        <button class="btn btn-custom pull-left btn-register-user-r">
                            <span>{{ trans('main.sign_in') }}</span></button>
                        <div class="h-10"></div>
                        <div class="f_link">
                ...
                <div class="box forgetbox">
                    ...
                    <form class="form" action="/user/reset" method="post">
                        ...
                        <button class="btn btn-primary pull-left white-c"><span>{{ trans('main.reset') }}</span>
                        </button>
                    </form>
                </div>
                <div class="box registerBox" style="height: 650px">
                    ...
                    <form class="form" method="post" action="/registerUser" style="text-align: left">
                        ...
                        <div class="f_row">
                            ...
                            <input type="name" name="name" class="input-field validate"
                                   valid-title="Enter your real name" required>
                            <u></u>
                        </div>
